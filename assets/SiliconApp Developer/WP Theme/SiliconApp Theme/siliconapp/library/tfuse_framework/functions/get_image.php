...
function tfuse_get_image($width = null, $height = null, $link = 'img', $key = 'attach', $id = null, $return = false, $class = '', $rel = '', $alt = '', $before = '', $after = '', $resize = null, $quality = 100, $order = 'ASC') {
	...
	if($link == 'img')  $img_link = '<img src="'. $img_src .'" '. $set_height . $set_width . $set_class . $set_rel . $set_alt . ' />';
    if($link == 'src')  $img_link = $img_src;
	else                $img_link = '<img src="'. $img_src .'" '. $set_height . $set_width . $set_class . $set_rel . $set_alt . ' />';
